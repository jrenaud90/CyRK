...
cdef (double, Py_ssize_t) interpj_ptr(double desired_x, double* x_domain, double* dependent_values,
                                       Py_ssize_t len_x, Py_ssize_t provided_j = *) noexcept nogil
...
cdef (double complex, Py_ssize_t) interp_complexj_ptr(double desired_x, double* x_domain,
...
cdef double interp_ptr(double desired_x, double* x_domain, double* dependent_values,
                        Py_ssize_t len_x, Py_ssize_t provided_j = *) noexcept nogil

cpdef double complex interp_complex(double desired_x, double[:] x_domain, double complex[:] dependent_values,
                                    Py_ssize_t provided_j = *) noexcept nogil

cdef double complex interp_complex_ptr(double desired_x, double* x_domain, double complex* dependent_values,
                                        Py_ssize_t len_x, Py_ssize_t provided_j = *) noexcept nogil
