import numpy as np
from CyRK import nbsolve2_ivp as nbsolve_ivp, nb_diffeq_addr
...
def test_pysolve_extra_output_with_dense():
    ...
    dense_out_float = result.call(0.3)
    ...
    dense_out_array = result.call_vectorize(np.asarray([0.3, 4.0, 8., 9.10, 9.9]))
