...
def test_basic_integration():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds)
...
def test_different_tols():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, rtol=1.0e-10, atol=1.0e-12)
...
def test_max_step():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, max_step=1.0e5)
...
def test_first_step():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, first_step=0.01)
...
def test_rk23_large_end_value():
    """Check that the cython solver is able to run using the RK23 method. Using a larger ending time value """

    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span_large, initial_conds, rk_method=0, rtol=1.0e-9, atol=1.0e-10)
...
def test_rk45_large_end_value():
    """Check that the cython solver is able to run using the RK45 method. Using a larger ending time value """

    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span_large, initial_conds, rk_method=1)
...
def test_dop853():
    """Check that the cython solver is able to run using the DOP853 method """

    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, rk_method=2)
...
def test_dop853_large_end_value():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span_large, initial_conds, rk_method=2)
...
def test_teval():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, t_eval=t_eval)
...
def test_args():
    ...
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq_args, time_span, initial_conds, args=(0.01, 0.02))
...
def test_accuracy():
    ...
    # CyRK
    time_domain, y_results, success, message = \
        cyrk_ode(diffeq, time_span, initial_conds, rk_method=1, rtol=rtol, atol=atol, t_eval=time)
